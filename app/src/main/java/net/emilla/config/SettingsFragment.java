...
//    }
    ...
    private void setupSoundSetPref(/*Context ctx, SharedPreferences prefs, Resources res*/) {
        ...
        soundSetPref.setOnPreferenceChangeListener((pref, newVal) -> {
            ...
            if (mCustomSounds != customSounds) {
                updateCustomSoundPrefs(/*ctx, prefs, res,*/ customSounds);
    ...
    private void setupCustomSoundPref(/*Context ctx,*/ SharedPreferences prefs,
    ...
    //            if (uriStr != null) {
    //                Ringtone ringtone = RingtoneManager.getRingtone(ctx, Uri.parse(uriStr));
    //                if (ringtone != null) {
    ...
    private void setupCustomSoundPrefs(/*Context ctx,*/ SharedPreferences prefs, /*Resources res,*/
            boolean enabled) {
        setupCustomSoundPref(/*ctx,*/ prefs, /*res,*/ Chimer.PREF_START, enabled/*, R.string.chime_start*/);
        setupCustomSoundPref(/*ctx,*/ prefs, /*res,*/ Chimer.PREF_ACT, enabled/*, R.string.chime_act*/);
        setupCustomSoundPref(/*ctx,*/ prefs, /*res,*/ Chimer.PREF_PEND, enabled/*, R.string.chime_pend*/);
        setupCustomSoundPref(/*ctx,*/ prefs, /*res,*/ Chimer.PREF_RESUME, enabled/*, R.string.chime_resume*/);
        setupCustomSoundPref(/*ctx,*/ prefs, /*res,*/ Chimer.PREF_EXIT, enabled/*, R.string.chime_exit*/);
        setupCustomSoundPref(/*ctx,*/ prefs, /*res,*/ Chimer.PREF_SUCCEED, enabled/*, R.string.chime_succeed*/);
        setupCustomSoundPref(/*ctx,*/ prefs, /*res,*/ Chimer.PREF_FAIL, enabled/*, R.string.chime_fail*/);
    }

    private void updateCustomSoundPref(/*Context ctx, SharedPreferences prefs, Resources res,*/
            String prefKey, boolean enabled/*, @StringRes int resId*/) {
        Preference soundPref = findPreference(prefKey);
        if (soundPref == null) return;
        soundPref.setVisible(enabled);
    }

    private void updateCustomSoundPrefs(/*Context ctx, SharedPreferences prefs, Resources res,*/
            boolean enabled) {
        updateCustomSoundPref(/*ctx, prefs, res,*/ Chimer.PREF_START, enabled/*, R.string.chime_start*/);
        updateCustomSoundPref(/*ctx, prefs, res,*/ Chimer.PREF_ACT, enabled/*, R.string.chime_act*/);
        updateCustomSoundPref(/*ctx, prefs, res,*/ Chimer.PREF_PEND, enabled/*, R.string.chime_pend*/);
        updateCustomSoundPref(/*ctx, prefs, res,*/ Chimer.PREF_RESUME, enabled/*, R.string.chime_resume*/);
        updateCustomSoundPref(/*ctx, prefs, res,*/ Chimer.PREF_EXIT, enabled/*, R.string.chime_exit*/);
        updateCustomSoundPref(/*ctx, prefs, res,*/ Chimer.PREF_SUCCEED, enabled/*, R.string.chime_succeed*/);
        updateCustomSoundPref(/*ctx, prefs, res,*/ Chimer.PREF_FAIL, enabled/*, R.string.chime_fail*/);
    }
