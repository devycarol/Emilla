...
public static int appSetId(String pkg, String cls) {
    ...
    case Apps.PKG_MARKOR -> cls.equals(Apps.CLS_MARKOR_MAIN) ? R.array.aliases_markor : 0;
...
public static Set<String> appSet(SharedPreferences prefs, Resources res,
    ...
    return setId == 0 ? null : prefs.getStringSet("aliases_" + pkg, Set.of(res.getStringArray(setId)));
}
}
