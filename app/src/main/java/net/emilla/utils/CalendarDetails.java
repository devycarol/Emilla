...
import static android.provider.CalendarContract.Events.ACCESS_CONFIDENTIAL;
import static android.provider.CalendarContract.Events.ACCESS_PRIVATE;
import static android.provider.CalendarContract.Events.ACCESS_PUBLIC;
...
import static android.provider.CalendarContract.Events.AVAILABILITY_TENTATIVE;
