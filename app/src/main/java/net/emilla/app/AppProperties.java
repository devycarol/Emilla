...
public final class AppProperties {
     ...
     * @param aliases the app's default set of aliases.
     * @param summary the app's summary description.
     * @param suppressedActions bit-flags of {@link AppActions} the app command shouldn't use.
     * @return app properties with the given attributes.
     */
    public static AppProperties suppressive(
    ...
    /**
     * FOSS app properties with total action suppression. Use this if an app has secondary launchers.
     *
     * @return generic app properties with all sub-actions suppressed.
     */
    ...
    /**
     * FOSS app properties with action suppression. Use this if the app has obnoxious, redundant, or
     * broken intent filters.
     *
     * @param aliases the app's default set of aliases.
     * @param summary the app's summary description.
    ...
    /// A bit-mask excluding {@link AppActions} this app's command shouldn't use.
    public final int actionMask;
    /// Whether the app is known to be open source.
    public final boolean verifiedFoss;
