...
public sealed class Pinger permits ChanneledPinger {
    ...
    public @open void ping() {
        int id = mSlot == PingChannels.SLOT_UNLIMITED
            ? uniqueSlot()
            : mSlot
        ;
        // this can be used to edit or remove the notification later.
        this.notifier.notify(id, mPing);
    }
}
