...
public enum CoreEntry {
    CALL(Call.ENTRY, Call::new, R.string.command_call, R.array.aliases_call, R.string.instruction_phone, R.drawable.ic_call, R.string.summary_call, R.string.manual_call) {
        ...
        @Override
        public CoreCommand.Yielder yielder() {
            return Call.yielder();
        }
    ...
    SETTING(Setting.ENTRY, Setting::new, R.string.command_setting, R.array.aliases_setting, R.string.instruction_setting, R.drawable.ic_settings, R.string.summary_setting, R.string.manual_setting, false) {

        @Override @Nullable
        public CoreCommand.Yielder yielder() {
            return null/*Setting.yielder()*/;
        }
    ...
    NOTE(Note.ENTRY, Note::new, R.string.command_note, R.array.aliases_note, R.string.instruction_file, R.drawable.ic_note, R.string.summary_note, R.string.manual_note, false) {

        @Override @Nullable
        public CoreCommand.Yielder yielder() {
            return null/*Note.yielder()*/;
        }
    ...
    TODO(Todo.ENTRY, Todo::new, R.string.command_todo, R.array.aliases_todo, R.string.instruction_todo, R.drawable.ic_todo, R.string.summary_todo, R.string.manual_todo, false) {

        @Override @Nullable
        public CoreCommand.Yielder yielder() {
            return null/*Todo.yielder()*/;
        }
    ...
    FIND(Find.ENTRY, Find::new, R.string.command_find, R.array.aliases_find, R.string.instruction_find, R.drawable.ic_find, R.string.summary_find, R.string.manual_find, false) {

        @Override @Nullable
        public CoreCommand.Yielder yielder() {
            return null/*Find.yielder()*/;
        }
    ...
    TIMER(Timer.ENTRY, Timer::new, Timer.NAME, Timer.ALIASES, R.string.instruction_timer, R.drawable.ic_timer, R.string.summary_timer, R.string.manual_timer) {

        @Override
        public CoreCommand.Yielder yielder() {
            return Timer.yielder();
        }
    ...
    CALCULATE(Calculate.ENTRY, Calculate::new, Calculate.NAME, Calculate.ALIASES, R.string.instruction_calculate, R.drawable.ic_calculate, R.string.summary_calculate, R.string.manual_calculate) {

        @Override
        public CoreCommand.Yielder yielder() {
            return Calculate.yielder();
        }
    ...
    PAUSE(Pause.ENTRY, Pause::new, R.string.command_pause, R.array.aliases_pause, R.string.instruction_pause, R.drawable.ic_pause, R.string.summary_pause, R.string.manual_pause) {

        @Override
        public CoreCommand.Yielder yielder() {
            return Pause.yielder();
        }
    ...
    TORCH(Torch.ENTRY, Torch::new, R.string.command_torch, R.array.aliases_torch, R.string.instruction_torch, R.drawable.ic_torch, R.string.summary_torch, R.string.manual_torch) {

        @Override
        public CoreCommand.Yielder yielder() {
            return Torch.yielder();
        }
    ...
    public final CoreCommand.Maker maker;
    @StringRes
    ...
    CoreEntry(
        ...
        this(entry, maker, name, aliases, instruction, icon, summary, manual, true);
    }
