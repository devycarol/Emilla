...
public class Share extends CoreDataCommand {
    ...
    private final Intent mIntent = Apps.sendTask().putExtra(EXTRA_TEXT, ""); // TODO: attachments
    ...
    protected void runWithData(String text) {
        ...
        appSucceed(createChooser(mIntent.putExtra(EXTRA_TEXT, text), title));
    }
